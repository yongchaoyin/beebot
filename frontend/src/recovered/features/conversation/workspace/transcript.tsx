  ...
  return (
    ...
    >
      ...
      {hasActions ? <div aria-label={messageActionLabel(entry)} className="sand-message-hover-actions" role="toolbar">
        ...
        {menuOpen ? <div aria-label="More message actions" role="menu" style={{ position: "absolute", right: 0, bottom: "34px", display: "grid", minWidth: "150px", padding: "4px", background: "var(--bb-surface, #20231f)", color: "var(--bb-text, #fff)", border: "1px solid var(--bb-border, #343832)", borderRadius: "8px", boxShadow: "var(--bb-shadow, 0 12px 28px rgba(0, 0, 0, .35))" }}>
