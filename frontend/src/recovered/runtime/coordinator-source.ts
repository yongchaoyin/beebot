...
const TELEMETRY_DOMAIN_BY_METHOD: Record<CoordinatorMethod, string> = {
  ...
  sendPrompt: "send", stopConversation: "send", getConversationActivity: "transcript", cancelQueuedConversationMessage: "send", promptAcceptanceStatus: "send", reactToMessage: "send",
