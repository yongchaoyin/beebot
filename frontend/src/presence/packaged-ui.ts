...
export function createPresenceWorkStatus(React: typeof ReactAPI) {
  ...
  return function WorkStatus({ agent }: { agent: WorkState }) {
    ...
    return label == null ? null : React.createElement("small", { className: "bb-status", "data-state": label.state }, React.createElement("span", { className: "bb-status__label" }, lang === "zh" ? label.zh : label.en));
  };
}
