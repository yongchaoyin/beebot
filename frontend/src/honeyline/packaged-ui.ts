...
export function createHoneylineWorkStatus(React: typeof ReactAPI) {
  ...
  return function WorkStatus({ agent }: { agent: WorkState }) {
    ...
    return label == null ? null : React.createElement("small", { className: "bee-status", "data-state": label.state, title: lang === "zh" ? label.zh : label.en }, React.createElement("span", { className: "bee-status__label" }, lang === "zh" ? label.zh : label.en));
  };
}
