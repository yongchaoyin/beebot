...
- assert or grant an upstream source-code license for reconstructed runtime,
  renderer, protocol, or installer material; or
- cover the pinned Grok Bot 0.18.0 macOS and Windows installers stored under
  `research-archives/` through Git LFS. Those artifacts remain subject to their
  own terms.

Anyone publishing or distributing this repository should independently review
copyright, trademark, third-party dependency, and service-terms obligations.
