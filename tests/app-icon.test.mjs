...
test("BeeBot Dock icon is the original Presence artwork, never the upstream blob", async () => {
  const { presenceIconSvg } = await import("../scripts/lib/presence-icon.mjs");
...
test("all macOS icon representations are generated at package time from tracked SVG", async () => {
  ...
  assert.match(source, /presenceIconSvg/);
