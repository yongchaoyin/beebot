...
export function createHostGatewayApi(
  ...
  return {
    ...
    getWorkReview: (args: unknown) => method(manager, "getWorkReview")(args),
    submitWorkReview: (args: unknown) => { markActive("user_action"); return method(manager, "submitWorkReview")(args); },
