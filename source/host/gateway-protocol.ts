...
export const SAND_GATEWAY_COMMANDS = {
  ...
  getConversationActivity: (api: GatewayApi, body: string) => api.getConversationActivity(parseCommandArgs(body)),
  cancelQueuedConversationMessage: (api: GatewayApi, body: string) => api.cancelQueuedConversationMessage(parseCommandArgs(body)),
