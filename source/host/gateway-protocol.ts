...
export const SAND_GATEWAY_COMMANDS = {
  ...
  getWorkReview: (api: GatewayApi, body: string) => api.getWorkReview(parseCommandArgs(body)),
  submitWorkReview: (api: GatewayApi, body: string) => api.submitWorkReview(parseCommandArgs(body)),
