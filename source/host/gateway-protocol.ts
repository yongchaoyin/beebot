...
export const SAND_GATEWAY_COMMANDS = {
  ...
  getBotRole: (api: GatewayApi, body: string) => api.getBotRole(parseCommandArgs(body)),
  updateBotRole: (api: GatewayApi, body: string) => api.updateBotRole(parseCommandArgs(body)),
  getCollaboration: (api: GatewayApi, body: string) => api.getCollaboration(parseCommandArgs(body)),
  reviewCollaboration: (api: GatewayApi, body: string) => api.reviewCollaboration(parseCommandArgs(body)),
