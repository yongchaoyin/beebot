...
export const SAND_DISK_SAVER_KICKSTART_PROMPT = [
  "[disk saver] You were just provisioned because your box — the machine Shell and Read act on — is low on disk space. This cue comes from BeeBot itself, not from the user; nothing has reached them yet.",
  DISK_SAVER_TASK,
...
export const SAND_DISK_SAVER_REAUDIT_PROMPT = [
  "[disk saver] Your box — the machine Shell and Read act on — is low on disk space again. This cue comes from BeeBot itself because disk pressure returned, not from the user.",
  DISK_SAVER_TASK,
