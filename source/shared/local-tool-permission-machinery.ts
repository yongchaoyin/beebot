...
export const SAND_LOCAL_TOOLS_UNDESCRIBABLE_MESSAGE = "BeeBot could not describe that request to the user's computer, so it could not ask permission for it and did not run it. Use your own computer instead (Shell, Read, AwaitShell).";
